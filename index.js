...
const client = new discord.Client({ disableEveryone: true }); //n`ow i am a cool programmer ;d
...
client.on("ready", () => {
  ...
  client.user.setActivity(`Pingu BOT`); //this set the bot presence staus, if you don't want presence delete this line
});
